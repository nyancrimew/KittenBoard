...
public class RichInputMethodSubtype {
    ...
    private static final RichInputMethodSubtype PLACEHOLDER_NO_LANGUAGE_SUBTYPE =
            new RichInputMethodSubtype(new InputMethodSubtype.InputMethodSubtypeBuilder()
                    ...
                    .setSubtypeExtraValue(EXTRA_VALUE_OF_PLACEHOLDER_NO_LANGUAGE_SUBTYPE)
                    .setIsAsciiCapable(true)
                    .setSubtypeId(SUBTYPE_ID_OF_PLACEHOLDER_NO_LANGUAGE_SUBTYPE)
                    .build());
    ...
    private static final RichInputMethodSubtype PLACEHOLDER_EMOJI_SUBTYPE = new RichInputMethodSubtype(
            new InputMethodSubtype.InputMethodSubtypeBuilder()
                    ...
                    .setSubtypeLocale(SubtypeLocaleUtils.NO_LANGUAGE)
                    .setSubtypeMode(KEYBOARD_MODE)
                    .setSubtypeExtraValue(EXTRA_VALUE_OF_PLACEHOLDER_EMOJI_SUBTYPE)
                    .setSubtypeId(SUBTYPE_ID_OF_PLACEHOLDER_EMOJI_SUBTYPE)
                    .build());
